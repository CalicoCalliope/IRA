...
var require_main = __commonJS({
  "node_modules/dotenv/lib/main.js"(exports2, module2) {
    ...
    function _resolveHome(envPath2) {
      return envPath2[0] === "~" ? path2.join(os3.homedir(), envPath2.slice(1)) : envPath2;
    }
...
var openSearchUrl = process.env.OPENSEARCH_CLOUD_URL;
var openSearchUser = process.env.OPENSEARCH_API_USER;
var openSearchPass = process.env.OPENSEARCH_API_PASSWORD;
var qdrantUrl = process.env.QDRANT_URL;
var qdrantKey = process.env.QDRANT_KEY;
  ...
  return new Promise((resolve2) => {
    (0, import_child_process.exec)("python --version", (err, stdout) => {
      ...
      (0, import_child_process.exec)("pip list --format=json", (err2, stdout2) => {
        ...
        resolve2({ pythonVersion, packages });
      });
    });
  });
}
async function logPEM(pem) {
  ...
  const workingDirectory = workspaceFolders[0] ?? os2.homedir();
...
function activate(context) {
  const runAndCaptureErrors = vscode.commands.registerCommand("IRA.runPythonAndCaptureErrors", async () => {
    ...
    (0, import_child_process.exec)(`python "${filePath}"`, async (error, stdout, stderr) => {
      if (stdout) {
